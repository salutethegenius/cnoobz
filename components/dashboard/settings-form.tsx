  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              autoComplete="off"
            />
            <p className="text-xs text-[var(--noob-blue)]/55">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="flex h-10 w-full rounded-md border border-[var(--noob-muted)] bg-white px-3 text-sm text-[var(--noob-blue)]"
            >
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-[var(--noob-blue)]/70">
